...
<html class="no-js" lang="">
    ...
    <body>
		...
		<div class="case-study-area case1-study pt-120 pb-90">
			<div class="container">
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="case-study-wrapper mb-30">
							<div class="case-study-img">
								<a href="#"><img src="img/case/case1.jpg" alt="" /></a>
								<div class="case-study-text">
									<a href="#">Financial</a>
									<h4><a href="#">Faculty have found the case vides wide canvas to discuss </a></h4>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="case-study-wrapper mb-30">
							<div class="case-study-img">
								<a href="#"><img src="img/case/case2.jpg" alt="" /></a>
								<div class="case-study-text">
									<a href="#">Business</a>
									<h4><a href="#">Always has beenut we don’t often talk about the ugly sides</a></h4>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="case-study-wrapper mb-30">
							<div class="case-study-img">
								<a href="#"><img src="img/case/case3.jpg" alt="" /></a>
								<div class="case-study-text">
									<a href="#">Marketing</a>
									<h4><a href="#">Faculty have found the case vides wide canvas to discuss </a></h4>
								</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="case-study-wrapper mb-30">
							<div class="case-study-img">
								<a href="#"><img src="img/case/case4.jpg" alt="" /></a>
								<div class="case-study-text">
									<a href="#">Consulting</a>
									<h4><a href="#">Mensch of malden mills there’s a silver lining to this story</a></h4>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="case-study-wrapper mb-30">
							<div class="case-study-img">
								<a href="#"><img src="img/case/case5.jpg" alt="" /></a>
								<div class="case-study-text">
									<a href="#">analysis</a>
									<h4><a href="#">Most of the business case studies on Malden Mills talk feuers</a></h4>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="case-study-wrapper mb-30">
							<div class="case-study-img">
								<a href="#"><img src="img/case/case6.jpg" alt="" /></a>
								<div class="case-study-text">
									<a href="#">seo</a>
									<h4><a href="#">Even though I was buyin product directly from them so nice</a></h4>
								</div>
							</div>
						</div>
					</div>
