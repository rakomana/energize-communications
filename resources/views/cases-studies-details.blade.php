...
<html class="no-js" lang="zxx">
    ...
    <body>
		...
		<div class="case-details-area pt-120 pb-85">
			<div class="container">
				<div class="row">
					<div class="col-xl-8 col-lg-8">
						<div class="case-details-wrapper">
							<div class="case-details-img">
								<img src="img/case/case-details1.jpg" alt="" />
							</div>
							...
							<div class="row">
								<div class="col-xl-6 col-lg-6 mb-60">
									<div class="case-details2-text">
										<h4><i class="fas fa-check"></i> How you can improve your business</h4>
										<p>But many People can not orem ipsum dolor cons ectetur adipisicing elit, sed do eiusmod tempor incididunt labore et dolore magna aliqua. Ut enim ad minim veniam quis nostrud exercitation ullamco laboris nisi ut aliquip exea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum tudin mauris.</p>
									</div>
								</div>
								<div class="col-xl-6 col-lg-6 mb-60">
									<div class="case-details2-img">
										<img src="img/case/case-details2.jpg" alt="" />
									</div>
								</div>
								<div class="col-xl-6 col-lg-6 mb-55">
									<div class="case-details2-img">
										<img src="img/case/case-details3.jpg" alt="" />
									</div>
								</div>
								<div class="col-xl-6 col-lg-6 mb-55">
									<div class="case-details2-text">
										<h4><i class="fas fa-check"></i>Many variations of passages available</h4>
										<p>But many People can not orem ipsum dolor cons ectetur adipisicing elit, sed do eiusmod tempor incididunt labore et dolore magna aliqua. Ut enim ad minim veniam quis nostrud exercitation ullamco laboris nisi ut aliquip exea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum tudin mauris.</p>
									</div>
								</div>
							</div>
							...
							<div class="case-details3-img">
								<img src="img/case/1.png" alt="" />
							</div>
							<div class="row">
								<div class="col-xl-6 col-lg-6 col-md-6 mb-30">
									<div class="case-details-text case1-details-text">
										<h3>Result</h3>
										<p>Sorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur xcepteur sint occaecat.</p>
									</div>
								</div>
								<div class="col-xl-6 col-lg-6 col-md-6 mb-30">
									<ul class="case-details-menu">
