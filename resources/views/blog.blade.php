				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="latest-news-wrapper mb-50">
							...
							<div class="latest-news-text">
								...
								<h4>
									<a href="#">When and where consumers search engines to find businesses</a>
								</h4>
								<p>Donec lobortis risus a elit stiam tempor. Ut uco rper ligula eu tempor congue eros est euismod turpis id tincidunt
									sapien risus a quam.</p>
								<a href="#"> Read more
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="latest-news-wrapper mb-50">
							<div class="latest-news-img">
								<a href="#">
									<img src="img/news/news8.jpg" alt="" />
								</a>
							</div>
							<div class="latest-news-text">
								<span>05 June 2018</span>
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="latest-news-wrapper mb-50">
							<div class="latest-news-img">
								<a href="#">
									<img src="img/news/news9.jpg" alt="" />
								</a>
							</div>
							<div class="latest-news-text">
								<span>05 June 2018</span>
