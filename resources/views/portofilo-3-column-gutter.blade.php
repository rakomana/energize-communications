    ...
    <body>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="breadcrumb-text text-center">
							<h1>Portfolio 3 Columns <br> Width Gutter</h1>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="project-area gray-bg pt-115 pb-90">
			<div class="container">
				...
				<div class="row grid">
					<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 grid-item cat1 cat3">
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 grid-item cat3 cat5">
						<div class="project-wrapper mb-30">
							<div class="project-img">
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 grid-item cat4 cat2">
						<div class="project-wrapper mb-30">
							<div class="project-img">
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 grid-item cat1 cat2 cat5">
						<div class="project-wrapper mb-30">
							<div class="project-img">
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 grid-item cat4 cat3 cat5">
						<div class="project-wrapper mb-30">
							<div class="project-img">
