...
<html class="no-js" lang="">
    ...
    <body>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="breadcrumb-text text-center">
							<h1>Portfolio 2 Columns <br> No Gutter</h1>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- project-area-start -->
		<div class="project-area gray-bg pt-115">
			<div class="container">
				...
				<div class="row no-gutters grid">
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item cat1 cat3">
						<div class="project-wrapper">
							<div class="project-img">
								...
								<div class="project-link">
									<a class="image-link" href="img/project/large/project1.jpg">
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item cat3 cat5">
						<div class="project-wrapper">
							<div class="project-img">
								<img src="img/project/large/project6.jpg" alt="" />
								<div class="project-content">
									<span>Finance, Business</span>
									<h4>
										<a href="#">Financial Planning</a>
								...
								<div class="project-link">
									<a class="image-link" href="img/project/large/project6.jpg">
										<i class="fas fa-long-arrow-alt-right"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item cat4 cat2">
						<div class="project-wrapper">
							<div class="project-img">
								...
								<div class="project-link">
									<a class="image-link" href="img/project/large/project2.jpg">
										<i class="fas fa-long-arrow-alt-right"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item cat1 cat2 cat5">
						<div class="project-wrapper">
							<div class="project-img">
								<img src="img/project/large/project3.jpg" alt="" />
								<div class="project-content">
									<span>Finance, Business</span>
									<h4>
										<a href="#">Financial Planning</a>
								...
								<div class="project-link">
									<a class="image-link" href="img/project/large/project3.jpg">
										<i class="fas fa-long-arrow-alt-right"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item cat4 cat3 cat5">
						<div class="project-wrapper">
							<div class="project-img">
								<img src="img/project/large/project4.jpg" alt="" />
								<div class="project-content">
									<span>Finance, Business</span>
									<h4>
										<a href="#">Financial Planning</a>
								...
								<div class="project-link">
									<a class="image-link" href="img/project/large/project4.jpg">
										<i class="fas fa-long-arrow-alt-right"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item  cat3 cat5">
						<div class="project-wrapper">
							<div class="project-img">
								...
								<div class="project-link">
									<a class="image-link" href="img/project/large/project5.jpg">
										<i class="fas fa-long-arrow-alt-right"></i>
									</a>
								</div>
							</div>
