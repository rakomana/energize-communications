...
<html class="no-js" lang="">
    ...
    <body>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="breadcrumb-text text-center">
							<h1>Portfolio 2 Columns <br> With Masonry</h1>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- project-area-start -->
		<div class="project-area gray-bg pt-115 pb-70">
			<div class="container">
				<div class="portfolio-menu text-center mb-45">
					<button class="active" data-filter="*">All</button>
					<button data-filter=".cat1">Finance</button>
					<button data-filter=".cat2">Banking</button>
					<button data-filter=".cat3">Business</button>
					<button data-filter=".cat4">Marketing</button>
					<button data-filter=".cat5">Development</button>
				</div>
				<div class="row grid">
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item cat5 cat3">
						<div class="project-wrapper project-masonry mb-50">
							<div class="project-img">
								<img src="img/project/masonry/mas-1.jpg" alt="" />
								<div class="project-link">
									<a class="image-link" href="img/project/masonry/mas-1.jpg">
							...
							<div class="project-content project-content-bottom pt-20">
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item cat2 cat3">
						<div class="project-wrapper project-masonry mb-50">
							<div class="project-img">
								<img src="img/project/masonry/mas-2.jpg" alt="" />
								<div class="project-link">
									<a class="image-link" href="img/project/masonry/mas-2.jpg">
										<i class="fas fa-eye"></i>
									</a>
									<a href="#">
										<i class="fas fa-link"></i>
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item cat1 cat2">
						<div class="project-wrapper project-masonry mb-50">
							<div class="project-img">
								<img src="img/project/masonry/mas-3.jpg" alt="" />
								<div class="project-link">
									<a class="image-link" href="img/project/masonry/mas-3.jpg">
										<i class="fas fa-eye"></i>
									</a>
									<a href="#">
										<i class="fas fa-link"></i>
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item cat1 cat4">
						<div class="project-wrapper project-masonry mb-50">
							<div class="project-img">
								<img src="img/project/masonry/mas-4.jpg" alt="" />
								<div class="project-link">
									<a class="image-link" href="img/project/masonry/mas-4.jpg">
										<i class="fas fa-eye"></i>
									</a>
									<a href="#">
										<i class="fas fa-link"></i>
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item cat3 cat5">
						<div class="project-wrapper project-masonry mb-50">
							<div class="project-img">
								<img src="img/project/masonry/mas-5.jpg" alt="" />
								<div class="project-link">
									<a class="image-link" href="img/project/masonry/mas-5.jpg">
										<i class="fas fa-eye"></i>
									</a>
									<a href="#">
										<i class="fas fa-link"></i>
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 grid-item cat2 cat5">
						<div class="project-wrapper project-masonry mb-50">
							<div class="project-img">
								<img src="img/project/masonry/mas-6.jpg" alt="" />
								<div class="project-link">
									<a class="image-link" href="img/project/masonry/mas-6.jpg">
										<i class="fas fa-eye"></i>
									</a>
									<a href="#">
										<i class="fas fa-link"></i>
