...
<html class="no-js" lang="">
    ...
    <body>
		...
		<div class="services-area pt-115 pb-60">
			<div class="container">
				<div class="section-title section2-title text-center mb-50">
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="services2-wrapper mb-55">
							<div class="services-2-img">
								<img src="img/service/1.png" alt="" />
							</div>
							<div class="services-text services-2-text">
								<h4>Business Planning</h4>
								<p>Sunt in culpa qui officia deser cmollit anim id est laborum.Cura bitus tdunt lacusulla gravida pharetra.  </p>
							</div>
						</div>
					</div>
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
		...
		<!-- business-area-end -->
		<!-- we-are-area-start -->
		<div class="we-are-area pt-105 pb-80" style="background-image:url(img/bg/1.png)">
			<div class="container">
				<div class="row">
					<div class="col-xl-8">
						<div class="we-area-wrapper">
							<div class="we-area-text">
								<h1>Who We Are </h1>
								<span>Nullam varius turpis et commodo pharetra est eros biben del luctus magna felis sollicitudin mauris nteger mauris. </span>
		...
		<!-- we-are-area-end -->
		<!-- pricing-area-start -->
		<div class="pricing-area gray-bg pt-110 pb-90">
			<div class="container">
				...
				<div class="row">
					<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
						<div class="pricing-wrapper single-pricing single1-pricing text-center mb-30">
